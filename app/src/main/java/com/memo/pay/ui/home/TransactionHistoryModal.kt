 ...
 * <pre>
 *    TransactionHistoryModal.newInstance(30).show(supportFragmentManager, "dialog")
 * </pre>
 */
class TransactionHistoryModal : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(itemCount: Int): TransactionHistoryModal =
            TransactionHistoryModal().apply {
